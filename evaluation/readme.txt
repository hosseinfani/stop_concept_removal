...
Sample evaluation results have been pushed for threshold-based (threshold subfolder) and topk% (topk subfolder) for stopconcept identification for 0.0, 0.1, 0.2. We did up until 0.9, 1.0.